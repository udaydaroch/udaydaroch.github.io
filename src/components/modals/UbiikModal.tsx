                ...
                <div className="card border-0 bg-light rounded-4 h-100">
                  <div className="card-body p-3 p-md-4">
                    ...
                    <ul className="small text-muted ps-3 mb-0">
                      <li className="mb-1">
                        Developed UI enhancements for the Konfig application, including
                        PO search by serial number, relaxed PO format restrictions,
                        and a QA tab for quality-assurance fields.
                      </li>
                      <li className="mb-1">
                        Implemented logic to <strong>import and parse Tait Communications data</strong>,
                        mapping MAC addresses, serial numbers, and device metadata
                        to the correct <strong>purchase orders</strong>.
                      </li>
                      <li className="mb-1">
                        Ensured imported data integrity by handling partial matches,
                        duplicates, and missing fields, and supported CSV exports with
                        additional QA metadata.
                      </li>
                      <li className="mb-1">
                        Enhanced platform management by enabling default templates and
                        merging redundant entries (e.g., Tornado variants) to prevent
                        orphaned references.
                      </li>
                      <li className="mb-1">
                        Improved the UI by upgrading from <strong>Bootstrap 3 to 5</strong>,
                        modernising layout, spacing, and form controls while maintaining
                        consistent behaviour.
                      </li>
                      <li className="mb-1">
                        Refactored legacy UI code, removed deprecated classes, and
                        simplified component structure for maintainability.
                      </li>
                      <li className="mb-1">
                        Fixed production bugs including broken PO deletions and raw
                ...
                <div className="card border-0 bg-light rounded-4 h-100 shadow-sm">
                  <div className="card-body p-3 p-md-4">
                    ...
                    <ul className="small text-muted ps-3 mb-3">
                      <li className="mb-1">
                        Added and maintained <strong>unit tests</strong> for new features
                        such as raw config imports, deletions, and PO handling, ensuring
                        stability across releases.
                      </li>
                      <li className="mb-1">
                        Collaborated across multiple sprints (e.g., <strong>Sprints 198–202</strong>),
                        balancing feature work, bug fixes, and database clean-up tasks.
                      </li>
                      <li className="mb-1">
                        Contributed to the release of <strong>Konfig 6.0</strong>, shipping
                        resolved versions without regressions or disruptions.
                      </li>
                      <li className="mb-1">
                        Worked in a <strong>Docker-based environment</strong>, following
                        established patterns for safe deployment and configuration.
                      </li>
                      <li className="mb-1">
                        Improved application security by hiding sensitive listings and
                        pages for unauthorized users, displaying login prompts instead
                        of content.
                      </li>
                    </ul>
